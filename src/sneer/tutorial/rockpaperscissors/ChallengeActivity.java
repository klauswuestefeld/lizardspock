...
public class ChallengeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		alert("Choose your move against " + session.contact().nickname().mostRecent(),
	...
	private void waitForAdversary() {
		final ProgressDialog waiting = progressDialog("Waiting for " + session.contact().nickname().mostRecent() + "...");
	...
	private void onReply(Move theirMove) {
		...
		String message = "You used " + myMove + ". " + session.contact().nickname().mostRecent() + " used " + theirMove + ".";
